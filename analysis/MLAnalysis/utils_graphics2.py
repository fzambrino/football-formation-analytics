...
def visualizza_lavagnetta_ungherese2(
    ...
    # Salva i risultati in out/MLAnalysis/nome_script/
    current_dir = os.path.dirname(os.path.abspath(__file__))
    radice_progetto = os.path.abspath(os.path.join(current_dir, "..", ".."))

    cartella_output = os.path.join(radice_progetto, "out", "MLAnalysis",nome_script)
